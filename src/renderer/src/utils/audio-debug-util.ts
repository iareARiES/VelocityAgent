...
export function analyzeAudioBuffer(buffer: Buffer, label = 'Audio'): Record<string, any> {
...
export function saveDebugAudio(buffer: Buffer, type: string, timestamp = Date.now()): { pcmPath: string, wavPath: string, metaPath: string } {
